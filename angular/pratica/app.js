...
angular.module("cardapio").controller("cardapioCtrl", function ($scope) {
	...
	$scope.produtos = [
		...
		// Sushi
		{nome: "Sushi de Omelete", valor: "15", categoria: "Sushi - 8 Unidades por Porção"}, 
		{nome: "Sushi de Legume", valor: "14", categoria: "Sushi - 8 Unidades por Porção"}, 
		{nome: "Sushi de Atum", valor: "15", categoria: "Sushi - 8 Unidades por Porção"}, 
		{nome: "Sushi de Kani", valor: "16", categoria: "Sushi - 8 Unidades por Porção"}, 
		{nome: "Sushi de Salmão", valor: "18", categoria: "Sushi - 8 Unidades por Porção"}, 
		{nome: "Sushi de Camarão", valor: "18", categoria: "Sushi - 8 Unidades por Porção"}, 
		// Uramaki
		{nome: "Uramaki Legumes", valor: "15", categoria: "Uramaki - 8 Unidades por Porção"}, 
		{nome: "Uramaki Atum", valor: "16", categoria: "Uramaki - 8 Unidades por Porção"}, 
		{nome: "Uramaki de Kani", valor: "17", categoria: "Uramaki - 8 Unidades por Porção"}, 
		{nome: "Uramaki de Salmão Coberto", valor: "27", categoria: "Uramaki - 8 Unidades por Porção"}, 
		{nome: "Uramaki de Salmão", valor: "19", categoria: "Uramaki - 8 Unidades por Porção"}, 
		{nome: "Uramaki de Camarão", valor: "19", categoria: "Uramaki - 8 Unidades por Porção"},
                {nome: "Uramaki de Omelete", valor: "16", categoria: "Uramaki - 8 Unidades por Porção"}, 
		//Temaki
		...
		{nome: "Temaki Frito Atum", valor: "23", categoria: "Temaki Hot"},
                ...
                //Hot Roll
		{nome: "Hot Roll de Legumes", valor: "15", categoria: "Hot Roll - 8 Unidades por Porção"}, 
		{nome: "Hot Roll Omelete", valor: "16", categoria: "Hot Roll - 8 Unidades por Porção"}, 
		{nome: "Hot Roll Kani", valor: "17", categoria: "Hot Roll - 8 Unidades por Porção"}, 
		{nome: "Hot Roll Camarão", valor: "20", categoria: "Hot Roll - 8 Unidades por Porção"}, 
		{nome: "Hot Roll Salmão", valor: "20", categoria: "Hot Roll - 8 Unidades por Porção"}, 
		//Niguiri
		{nome: "Niguiri de Frango", valor: "16", categoria: "Niguiri - 8 Unidades por Porção"}, 
		{nome: "Niguiri Salmão", valor: "22", categoria: "Niguiri - 8 Unidades por Porção"}, 
		{nome: "Niguiri de Kani", valor: "17", categoria: "Niguiri - 8 Unidades por Porção"}, 
		//Sashimi
		{nome: "Sashimi com Cream Cheese", valor: "28", categoria: "Sashimi - 8 Unidades por Porção"}, 
		{nome: "Sashimi", valor: "24", categoria: "Sashimi - 8 Unidades por Porção"}, 
		//Rolinho Primavera
